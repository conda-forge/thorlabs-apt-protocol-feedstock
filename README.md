About thorlabs-apt-protocol-feedstock
=====================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/thorlabs-apt-protocol-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10389&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/thorlabs-apt-protocol-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `thorlabs-apt-protocol` can be installed with `conda`:
...
```
mamba install thorlabs-apt-protocol
```

It is possible to list all of the versions of `thorlabs-apt-protocol` available on your platform with `conda`:
...
```
mamba search thorlabs-apt-protocol --channel conda-forge
```
...
mamba repoquery search thorlabs-apt-protocol --channel conda-forge

# List packages depending on `thorlabs-apt-protocol`:
mamba repoquery whoneeds thorlabs-apt-protocol --channel conda-forge

# List dependencies of `thorlabs-apt-protocol`:
mamba repoquery depends thorlabs-apt-protocol --channel conda-forge
```
